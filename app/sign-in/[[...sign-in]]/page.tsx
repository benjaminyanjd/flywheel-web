        ...
        <div className="max-w-md">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">加密投資情報雷達</p>
            </div>
          </div>
          ...
          <p className="text-slate-400 mb-8 leading-relaxed">
            每 30 分鐘掃描 5 大信號源，AI 自動識別高置信度機會，生成可執行的落地方案。
          </p>
          <div className="space-y-4">
            {[
              { icon: "📡", title: "全源信號掃描", desc: "Reddit · HN · KOL · RSS · GitHub，每天 350+ 條信號" },
              { icon: "💎", title: "AI 機會識別", desc: "自動從噪音中提煉高置信度投資機會" },
              { icon: "📋", title: "落地方案生成", desc: "每個機會配備具體執行步驟、倉位建議、止損設置" },
            ].map(item => (
