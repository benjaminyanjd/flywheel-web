  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="text-center max-w-lg">
        ...
        <div className="bg-slate-800 rounded-xl p-5 mb-6 text-left border border-slate-700">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center">
              <div className="text-3xl font-bold text-indigo-400">{stats.totalOpps}</div>
        ...
        {/* 定價 */}
        <div className="bg-slate-800 rounded-xl p-5 mb-6 border border-indigo-500/30 text-left">
          <p className="text-sm font-semibold text-indigo-400 mb-3">🚀 正式版方案</p>
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl font-bold text-slate-100">$29<span className="text-sm text-slate-400">/月</span></span>
            </div>
            <hr className="border-slate-700" />
            <div className="flex justify-between items-center">
              <div>
                <p className="text-slate-200 font-medium">年度訂閱 <span className="text-xs bg-emerald-700 text-emerald-200 px-1.5 py-0.5 rounded ml-1">省 40%</span></p>
        ...
        <a
          ...
          className="inline-block w-full bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-3 rounded-lg font-medium transition-colors mb-3"
        >
          聯繫獲取正式授權 →
        </a>
